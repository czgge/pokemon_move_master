        ...
        {selectedPokemon && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={() => setSelectedPokemon(null)}>
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 overflow-y-auto lg:overflow-hidden flex-1">
                <div className="w-full lg:w-1/4 flex flex-col items-center lg:shrink-0">
